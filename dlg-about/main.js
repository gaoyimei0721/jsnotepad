...
var $dlgAbout = (function(){   
  var DOM=''
    ...
    +'      <p>Author:Gaoyimei</p>'
    +'      <p>Contact Me:1272379222@qq.com</p>'
    +'      <p>Github:<a href="https://github.com/gaoyimei0721">https://github.com/gaoyimei0721</a></p>'
  ...
  function show(){        
    ...
    $dlg.find('.dialogbox').draggable({handle:$dlg.find('.titlebar')});     $btnConfirm.click(function(){$dlg.remove();});                    
